 ...
 * generated in the com.jump_soft.estamp.fo10.common package. 
...
public class ObjectFactory {
    ...
    private final static QName _DeviceEditRequestDate_QNAME = new QName("http://www.jump-soft.com/estamp/fo10/common", "date");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.jump_soft.estamp.fo10.common
     * 
     */
    ...
    /**
     * Create an instance of {@link EStampCreateNegativeResponse }
     * 
     */
    public EStampCreateNegativeResponse createEStampCreateNegativeResponse() {
        return new EStampCreateNegativeResponse();
    }
    ...
    /**
     * Create an instance of {@link EStampConsumedStornoRequest }
     * 
     */
    public EStampConsumedStornoRequest createEStampConsumedStornoRequest() {
        return new EStampConsumedStornoRequest();
    }
    ...
    /**
     * Create an instance of {@link ServiceTerminationRequest }
     * 
     */
    public ServiceTerminationRequest createServiceTerminationRequest() {
        return new ServiceTerminationRequest();
    }
    ...
    /**
     * Create an instance of {@link EStampConsumedStornoResponse }
     * 
     */
    public EStampConsumedStornoResponse createEStampConsumedStornoResponse() {
        return new EStampConsumedStornoResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.jump-soft.com/estamp/fo10/common", name = "date", scope = DeviceEditRequest.class)
    public JAXBElement<XMLGregorianCalendar> createDeviceEditRequestDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_DeviceEditRequestDate_QNAME, XMLGregorianCalendar.class, DeviceEditRequest.class, value);
    }
