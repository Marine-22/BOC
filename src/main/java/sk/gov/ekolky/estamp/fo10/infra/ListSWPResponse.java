...
@XmlRootElement(name = "listSWPResponse")
public class ListSWPResponse
    extends Response
{

    @XmlElement(required = true)
    protected List<ListSWPResponse.Offices> offices;
    @XmlElement(required = true)
     ...
     * {@link ListSWPResponse.Offices }
     * 
     * 
     */
    public List<ListSWPResponse.Offices> getOffices() {
        if (offices == null) {
            offices = new ArrayList<ListSWPResponse.Offices>();
        }
        return this.offices;
    }
    ...
    public static class Offices {
        ...
        protected List<ListSWPResponse.Offices.Devices> devices;
        protected List<ListSWPResponse.Offices.Agendas> agendas;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ListSWPResponse.Offices.Devices }
         * 
         * 
         */
        public List<ListSWPResponse.Offices.Devices> getDevices() {
            if (devices == null) {
                devices = new ArrayList<ListSWPResponse.Offices.Devices>();
            }
            return this.devices;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ListSWPResponse.Offices.Agendas }
         * 
         * 
         */
        public List<ListSWPResponse.Offices.Agendas> getAgendas() {
            if (agendas == null) {
                agendas = new ArrayList<ListSWPResponse.Offices.Agendas>();
            }
            return this.agendas;
        }
