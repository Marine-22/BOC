    ...
    extends Response
{
    ...
    protected List<CloseResponse.Payments> payments;
     ...
     * {@link CloseResponse.Payments }
     * 
     * 
     */
    public List<CloseResponse.Payments> getPayments() {
        if (payments == null) {
            payments = new ArrayList<CloseResponse.Payments>();
        }
