 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="incidents" type="{http://www.ekolky.gov.sk/estamp/xsd10}incident" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "listDeviceInfoResponse")
public class ListDeviceInfoResponse
    extends Response
{

    protected List<ListDeviceInfoResponse.State> state;
     ...
     * {@link ListDeviceInfoResponse.State }
     * 
     * 
     */
    public List<ListDeviceInfoResponse.State> getState() {
        if (state == null) {
            state = new ArrayList<ListDeviceInfoResponse.State>();
        }
        return this.state;
    }
