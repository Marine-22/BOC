 ...
 *       &lt;sequence>
 *         &lt;element name="closure" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlRootElement(name = "getClosureResponse")
public class GetClosureResponse
    extends Response
{

    protected List<GetClosureResponse.Closure> closure;
     ...
     * {@link GetClosureResponse.Closure }
     * 
     * 
     */
    public List<GetClosureResponse.Closure> getClosure() {
        if (closure == null) {
            closure = new ArrayList<GetClosureResponse.Closure>();
        }
        return this.closure;
    }
    ...
    public static class Closure {
        ...
        protected List<GetClosureResponse.Closure.Payments> payments;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GetClosureResponse.Closure.Payments }
         * 
         * 
         */
        public List<GetClosureResponse.Closure.Payments> getPayments() {
            if (payments == null) {
                payments = new ArrayList<GetClosureResponse.Closure.Payments>();
            }
