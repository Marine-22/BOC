 ...
 * 
 */
@WebServiceClient(name = "estamp", targetNamespace = "http://www.ekolky.gov.sk/estamp/fo10", wsdlLocation = "file:/C:/Users/fmo/Desktop/wsdl/r1_2.wsdl.xml")
public class Estamp
    extends Service
{

    private final static URL ESTAMP_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(sk.gov.ekolky.estamp.fo10.Estamp.class.getName());
    ...
    public Estamp(URL wsdlLocation, QName serviceName) {
