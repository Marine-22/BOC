 ...
 *       &lt;sequence>
 *         &lt;element name="countries" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;complexContent>
    ...
    extends Response
{
    ...
    protected List<ListCountryResponse.Countries> countries;
     ...
     * {@link ListCountryResponse.Countries }
     * 
     * 
     */
    public List<ListCountryResponse.Countries> getCountries() {
        if (countries == null) {
            countries = new ArrayList<ListCountryResponse.Countries>();
        }
